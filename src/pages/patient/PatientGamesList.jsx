        ...
        {games.map((game) => {
          ...
          return (
            <motion.div
              key={game.id}
              whileHover={{ y: -4 }}
              className={`rounded-3xl md:rounded-4xl p-6 md:p-8 border-3 shadow-md flex flex-col justify-between ${game.color}`}
            >
              <div>
                <div className="flex items-start justify-between gap-4 mb-4">
                  <div className="p-3 bg-white dark:bg-[#1E293B] rounded-2xl shadow-sm border border-slate-200/60 dark:border-[#243352]">
                ...
                <h2 className="text-2xl font-black font-display text-slate-900 dark:text-white leading-snug">
                  {game.title}
                </h2>
